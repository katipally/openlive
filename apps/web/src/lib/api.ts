...
export interface AgentStatus { id: string; label: string; installed: boolean; credState: "ready" | "login_required" | "unknown"; authDetail?: string; canLogout: boolean; hidden: boolean; sessions: string; home: string }
